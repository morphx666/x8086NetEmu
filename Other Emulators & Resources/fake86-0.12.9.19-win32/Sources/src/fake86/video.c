...
void initcga() {
	...
	palettecga[0] = 0;							// 0
	palettecga[1] = rgb (0, 0, 0xAA);			// 1
	palettecga[2] = rgb (0, 0xAA, 0);			// 2
	palettecga[3] = rgb (0, 0xAA, 0xAA);		// 3
	palettecga[4] = rgb (0xAA, 0, 0);			// 4
	palettecga[5] = rgb (0xAA, 0, 0xAA);		// 5
	palettecga[6] = rgb (0xAA, 0x55, 0);		// 6
	palettecga[7] = rgb (0xAA, 0xAA, 0xAA);		// 7
	palettecga[8] = rgb (0x55, 0x55, 0x55);		// 8
	palettecga[9] = rgb (0x55, 0x55, 0xFF);		// 9
	palettecga[10] = rgb (0x55, 0xFF, 0x55);	// 10
	palettecga[11] = rgb (0x55, 0xFF, 0xFF);	// 11
	palettecga[12] = rgb (0xFF, 0x55, 0x55);	// 12
	palettecga[13] = rgb (0xFF, 0x55, 0xFF);	// 13
	palettecga[14] = rgb (0xFF, 0xFF, 0x55);	// 14
	palettecga[15] = rgb (0xFF, 0xFF, 0xFF);	// 15
